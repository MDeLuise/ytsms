...
import com.github.mdeluise.ytsms.authentication.UserRepository;
...
public class PermissionService {
    private final com.github.mdeluise.ytsms.authorization.permission.PermissionRepository permissionRepository;
    private final UserRepository userRepository;


    @Autowired
    public PermissionService(
        com.github.mdeluise.ytsms.authorization.permission.PermissionRepository permissionRepository, UserRepository userRepository) {
