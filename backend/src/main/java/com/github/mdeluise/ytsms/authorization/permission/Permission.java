...
public class Permission {
    ...
    @Column(length = 20)
    private com.github.mdeluise.ytsms.authorization.permission.PType type;
    ...
    public Permission(com.github.mdeluise.ytsms.authorization.permission.PType type, String resourceClassName, String resourceId) {
        this.type = type;
    ...
    public com.github.mdeluise.ytsms.authorization.permission.PType getType() {
        return type;
    }


    public void setType(com.github.mdeluise.ytsms.authorization.permission.PType type) {
        this.type = type;
    }
