package com.github.mdeluise.ytsms.security.jwt;
...
public class JwtWebUtil {
    ...
    @Autowired
    public JwtWebUtil(com.github.mdeluise.ytsms.security.jwt.JwtTokenUtil jwtTokenUtil, UserDetailsService userDetailsService) {
    ...
    public com.github.mdeluise.ytsms.security.jwt.JwtTokenInfo refreshToken(String token) {
    ...
    public com.github.mdeluise.ytsms.security.jwt.JwtTokenInfo generateJwt(UserDetails user) {
        return jwtTokenUtil.generateAccessToken(user);
    }
}
